...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [LEFT] = LAYOUT(
        _______,   KC_GRV,    SH_SLSH,  SH_LCBRK, SH_RCBRK,    KC_EQL,     KC_PGUP, C(KC_LEFT),        KC_UP, C(KC_RGHT), XXXXXXX, XXXXXXX,
    ...
    [SETTINGS] = LAYOUT(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, SH_FLASH, OS_RCTL, XXXXXXX, XXXXXXX, _______,
    ...
    [QUICK_SYMBOLS] = LAYOUT(
        ...
        _______, XXXXXXX, S(KC_4), S(KC_5), S(KC_6),  S(KC_0),      XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX,
...
layer_state_t default_layer_state_set_user(layer_state_t state) {
    ...
    rgblight_setrgb_at(2, 2, 2, 1);
    rgblight_setrgb_at(2, 2, 2, 2);
    rgblight_setrgb_at(2, 2, 2, 3);
    return state;
}
